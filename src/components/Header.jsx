    ...
    >
      <div className="container mx-auto relative flex items-center justify-between max-w-6xl">
        ...
        <nav  className="box-border">
          ...
          <i className="mobile-nav-toggle xl:hidden bi bi-list text-2xl cursor-pointer"></i>
        </nav>
      </div>
    </header>
  );
